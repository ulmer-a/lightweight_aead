...
extern const testcase_t isap_a_128_testcases[];
extern const unsigned long isap_a_128_testcases_count;

int test_isap_a_128_encrypt()
{
    for (int i = 0; i < isap_a_128_testcases_count; i++)
    {
        const testcase_t* tc = &isap_a_128_testcases[i];
