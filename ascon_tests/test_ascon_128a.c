...
extern const testcase_t ascon_128a_testcases[];
extern const unsigned long ascon_128a_testcases_count;

int test_ascon_128a_encrypt()
{
    for (int i = 0; i < ascon_128a_testcases_count; i++)
    {
        const testcase_t* tc = &ascon_128a_testcases[i];
